...
void LETIMER_Setup(void)
{
    ...
    LETIMER0->CNT = 0x1;                                        //Initialize counter to the least value
...
void LETIMER0_IRQHandler(void)
{
    ...
    else                                                                    //If COMP1 interrupts
    {
        ...
        {
            /* Activate DMA with the configuration */
            DMA_ActivateBasic(ADC0_DMA_Channel,true, false, (void *)ADC0_DMA_buffer, (void *)&ADC0->SINGLEDATA, NUMBER_OF_ADC_SAMPLES - 1);
            BlockSleepMode(ADC_EM);                                         //Block sleep mode for ADC
