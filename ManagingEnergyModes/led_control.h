...
__STATIC_INLINE void ledInit(void)
{
    ...
    GPIO_PinModeSet(gpioPortE, LED0Pin, gpioModePushPull, 0);         //Initialize LED0
    GPIO_PinModeSet(gpioPortE, LED1Pin, gpioModePushPull, 0);         //Initialize LED1
}
...
{
    GPIO_PinOutSet(gpioPortE,(led+2));
}
...
{
    GPIO_PinOutClear(gpioPortE,(led+2));
}
...
{
    GPIO_PinOutToggle(gpioPortE,(led+2));
}
